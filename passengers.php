...
<html lang="en">
    ...
    <body>
        ...
        <div id="root">
            ...
            <!-- sign in container-->
            <div class="container_signin" style="height:1400px;">
                ...
                <div class="admin-container">
                    ...
                    <div class="passenger-content">
                        ...
                        <h1 align="center"> List of Passengers </h1>
                        <br>
                            ...
                            <table border="1" width="70%" cellpadding="10" style="background-color:white;">
                                ...
                                <tr>
                                    <?php
                                        ...
                                        $column_names = array("Passenger_ID","First_Name", "Last_Name", "Contact_No","Email", "Account_Type","Username", "Passwords","Re_Password");
                                        for($i = 0; $i <= 8; $i++){
                                ...
                                <?php
                                    ...
                                    $sql_data = "SELECT * FROM Passenger";
                                    $sql_count = "SELECT COUNT(*) AS Len FROM Passenger";
